<manual>
  <fieldset>
    ...
    <label for="serial">Serial Number</label><input type="text" name="serial" placeholder="serial number" onblur={test}/><br>
    <label for="Denomination">Derived Denomination :{denom}</label><br>
    <label for="AN">Authenticity Code</label><input type="text" name="AN" placeholder="Authenticity Code" /><br>
    <button if={able} type="button" name="sub" onclick={submit}>Submit Codes</button>
    <p id="error">
